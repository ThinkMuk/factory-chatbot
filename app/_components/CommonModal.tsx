    ...
    >
      <div className='bg-white rounded-2xl shadow-lg w-[90%] max-w-[380px]'>
        ...
        <div className='px-5 py-4'>
          {typeof description === 'string' ? <p className='text-[14px] text-[#44526B]'>{description}</p> : description}
        </div>
        <div className='px-5 py-3 border-t border-black/10 flex items-center justify-end gap-2'>
          ...
          <button
            ...
            className='px-4 py-2 rounded-md text-[14px] font-semibold bg-[#17437C] text-white hover:bg-[#12365f] disabled:opacity-50 disabled:cursor-not-allowed'
          >
            {confirmText}
          </button>
        </div>
